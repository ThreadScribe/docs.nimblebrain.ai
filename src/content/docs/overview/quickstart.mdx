...
description: Empower your teams to be more productive today. Get started with NimbleBrain just a few easy clicks FOR FREE.
---

Getting started with NimbleBrain is a straightforward and quick process. 

To work with NimbleBrain, simply upload your **Dataset**, configure your **Agent** or **Workflow** and then unlock the power of your data.
...
1. ## Log in to NimbleBrain
    ...
    Click [HERE](https://app.nimblebrain.ai) to log in or sign up for NimbleBrain. Fill in your information and complete it by clicking `Continue`. 

    <div class="shadow">
      ![Installing NimbleBrain](../../../assets/signinpage.jpg)
    </div>
...
2. ## Configuring Datasets
    ...
    ![Installing NimbleBrain](../../../assets/Upload_datasource.jpg)
...
3. ## Configuring Agents
   ...
   To interact with your **Datasets** you need to configure an **Agent**. You can do this by selecting `Agents` in the top left Navigation Bar.
    ...
    ![Installing NimbleBrain](../../../assets/agent_step1.jpg)
    ...
    ![Installing NimbleBrain](../../../assets/agent_step3.jpg)
    ...
    ![Installing NimbleBrain](../../../assets/agent_configuration_basic.jpg)
    ...
    ![Installing NimbleBrain](../../../assets/agent_configuration_enhanced.jpg)
...
5. ## Workflows
    ...
    ![Installing NimbleBrain](../../../assets/workflows_homepage.jpg)
    ...
    ![Installing NimbleBrain](../../../assets/workflow_editor.jpg)
