---
title: Quickstart guide to NimbleBrain.ai
...
3. ## Configuring Agents
   ...
   To interact with your **Datasets** you need to configure an **Agent**. You can do this by selecting `Agents` in the top left Navigation Bar.
    ...
    ##### Enhance with AI
     ...
     On the **Configurations** tab, you will also see your **Agent Scorecard** which is graded on a scale from 0 to 10. The scorecard explains the strengths and weaknesses of your agent's configuration. You may enhance your agent by selecting the `Enhance with AI` button in the Agent Scorecard box. 
